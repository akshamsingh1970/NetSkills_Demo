...
//employee type list need to find out the names starting with A using stream API
...
public class JavaEmp {
    public static void main(String[] args) {
        ...
        employees.add(new Employee(35792, "Aaron"));
...
//        System.out.println();
        ...
        System.out.println();
        System.out.println("Employees name starting with A are:");

        List<String> EmployeeNames  = employees.stream().filter(employee -> employee.getName().charAt(0) == 'A' || employee.getName().charAt(0)=='a').map(employee -> employee.getName()).collect(Collectors.toList());
